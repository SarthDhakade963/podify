      ...
      <div className="relative z-10 text-center px-6 flex flex-col items-center">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl">
          <div className="text-center p-6 rounded-xl bg-gray-900/30 backdrop-blur-sm border border-gray-800 hover:border-orange-500/50 transition-all duration-300">
            ...
            <h3 className="text-orange-400 font-semibold mb-2">High Quality Audio</h3>
            <p className="text-gray-400 text-sm">Crystal clear sound for the best listening experience</p>
          </div>
          
          <div className="text-center p-6 rounded-xl bg-gray-900/30 backdrop-blur-sm border border-gray-800 hover:border-orange-500/50 transition-all duration-300">
            <div className="text-3xl mb-3">📱</div>
            <h3 className="text-orange-400 font-semibold mb-2">Multi-Platform</h3>
            <p className="text-gray-400 text-sm">Listen anywhere, anytime on any device</p>
          </div>
          
          <div className="text-center p-6 rounded-xl bg-gray-900/30 backdrop-blur-sm border border-gray-800 hover:border-orange-500/50 transition-all duration-300">
            <div className="text-3xl mb-3">🔍</div>
            <h3 className="text-orange-400 font-semibold mb-2">Smart Discovery</h3>
            <p className="text-gray-400 text-sm">Find new podcasts tailored to your interests</p>
          </div>
        </div>
      </div>
    </main>
