...
public class YouTubeServiceImpl implements YouTubeService {
    ...
    private static final String YT_SEARCH_URL = "https://www.googleapis.com/youtube/v3/search?part=snippet&type=video&maxResults=3&q=%s&key=%s";
    ...
    public List<PodcastDTO> fetchAndSavePodcasts(String topicName) {
        ...
        List<PodcastDTO> podcastDTOS = items.stream().map(item -> {
            try{
                ...
                String title = Objects.toString(snippet.get("title"), "untitled");
